...
},{}],"src/VueQuickCropper.vue":[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  methods: {
    ...
    // 判断图片方向
    imgDirection: function imgDirection() {
      var _this = this;
      ...
      this.$nextTick(function () {
        ...
        img.onload = function () {
          ...
          if (_this.orientation == 6) {
            ...
            _this.imgSrcs = _this.imgSrc;
            _this.initCanvas();
            return;
          }
          var width = _this.$el.getBoundingClientRect().width;
          var height = _this.$el.getBoundingClientRect().height;
          var canvas3 = document.createElement("canvas");
          var ctx3 = canvas3.getContext("2d");
          var fwidth = img.height;
          var fheight = img.width;
          ...
          var imgWidth = fwidth / rate;
          var imgHeight = fheight / rate;
          ...
          var base64 = canvas3.toDataURL();
          _this.imgSrcs = base64;
          _this.initCanvas();
        };
      });
    },
    ...
    initCanvas: function initCanvas() {
      ...
      this.$nextTick(function () {
        ...
        // 宽高等于容器宽高
        C.width = _this2.$el.getBoundingClientRect().width;
        C.height = _this2.$el.getBoundingClientRect().height;

        var ctx = C.getContext("2d");

        var img = new Image();

        img.src = _this2.imgSrcs;
        _this2.ctx = ctx;
        _this2.img = img;
        _this2.width = C.width;
        _this2.height = C.height;
        var rate = 1;
        ...
        img.onload = function () {
          ...
          var rectWidth = _this2.width * 0.8;
          var rectHeight = _this2.height * 0.8;
          var rectX = _this2.width * 0.1;
          var rectY = (_this2.height - rectWidth) / 2;
          _this2.imgWidth = img.width / rate;
          _this2.imgHeight = img.height / rate;
          _this2.posImg = { x: rectX, y: rectY };

          _this2.drawImg(ctx, img, rectX, rectY, _this2.imgWidth, _this2.imgHeight);
          // 裁剪框
          _this2.drawRect();
        };
      });
    ...
    handleTouchStart: function handleTouchStart(e) {
      ...
      if (e.touches.length == 2) {
        // 以左面手指位置为准
        var _x2 = e.touches[0].screenX <= e.touches[1].screenX ? e.touches[0].screenX : e.touches[1].screenX;
        var _y = e.touches[0].screenX <= e.touches[1].screenX ? e.touches[0].screenY : e.touches[1].screenY;
        this.startScreen = { x: _x2, y: _y };
        this.scaleStart = {
    ...
    handleTouchMove: function handleTouchMove(e) {
      ...
      if (e.touches.length == 2) {
        var _x3 = e.touches[0].screenX <= e.touches[1].screenX ? e.touches[0].screenX : e.touches[1].screenX;
        var _y2 = e.touches[0].screenX <= e.touches[1].screenX ? e.touches[0].screenY : e.touches[1].screenY;
        var _mx = _x3 - this.startScreen.x + this.posImg.x;
        var _my = _y2 - this.startScreen.y + this.posImg.y;
        this.scaleMove = {
          x1: e.touches[0].screenX,
          y1: e.touches[0].screenY,
          x2: e.touches[1].screenX,
        ...
        // 缩小的比例
        var widthRate = ((Math.abs(this.scaleStart.x2 - this.scaleStart.x1) - Math.abs(this.scaleMove.x2 - this.scaleMove.x1)) / Math.abs(this.scaleStart.x2 - this.scaleStart.x1)).toFixed(2);
        ...
        this.drawImg(this.ctx, this.img, _mx, _my, imgWidth, imgHeight);
...
//
//
        var $98df1f = exports.default || module.exports;
      
      if (typeof $98df1f === 'function') {
        $98df1f = $98df1f.options;
      }
    
        /* template */
        Object.assign($98df1f, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$98df1f', $98df1f);
          } else {
            api.reload('$98df1f', $98df1f);
          }
        }
...
},{"exif-js":"node_modules/exif-js/exif.js","_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/app.js":[function(require,module,exports) {
'use strict';
...
var _VueQuickCropper = require('./VueQuickCropper.vue');

var _VueQuickCropper2 = _interopRequireDefault(_VueQuickCropper);
...
//# sourceMappingURL=/app.754223ee.map